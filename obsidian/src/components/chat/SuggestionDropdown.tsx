  ...
  const renderItem = (item: NoteMetadata | SlashCommand, index: number) => {
    ...
    if (type === "mention") {
      ...
      return (
        ...
        >
          <div className="mention-dropdown-item-name">{note.name}</div>
          <div className="mention-dropdown-item-path">{note.path}</div>
        </div>
      );
    } else {
      // type === "slash-command"
      ...
      return (
        ...
        >
          <div className="mention-dropdown-item-name">/{command.name}</div>
